...
parser.add_argument('--batch_size', type=int, default=256, choices=[16,32,64,128,256,512], help='batch size')
...
parser.add_argument('--learning_rate', type=float, default=0.001, choices=[0.01,0.001,0.0005,0.0001,0.00005,0.00001],help = 'LR')
