...
parser.add_argument('--hidden_layer', type=int, default=4, choices=[2,3,4,5,6,7,8,9,10],help='number of hidden layer')
...
def main():
    ...
    for tra_index in range(tf.size):
        trajectory_time[tra_index,:] = trajectory_time[tra_index,:] * tf[tra_index]
